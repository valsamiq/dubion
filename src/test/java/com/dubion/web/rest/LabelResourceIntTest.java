...
public class LabelResourceIntTest {
    ...
    public void createLabel() throws Exception {
        ...
        assertThat(testLabel.getPhoto()).isEqualTo(DEFAULT_PHOTO);
        assertThat(testLabel.getPhotoContentType()).isEqualTo(DEFAULT_PHOTO_CONTENT_TYPE);
    ...
    public void updateLabel() throws Exception {
        ...
        assertThat(testLabel.getPhoto()).isEqualTo(UPDATED_PHOTO);
        assertThat(testLabel.getPhotoContentType()).isEqualTo(UPDATED_PHOTO_CONTENT_TYPE);
